...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val user1 = User("Harry", "Poter", "hpoter@gmail.com", "2345")
        val user2 = User("Michelle", "Celine", "mceline@gmail.com", "3456")
        val user3 = User("Trevor", "Noah", "tnoah@gmail.com", "4567")
        val user4 = User("Mary", "Grace", "mgrace@gmail.com", "5678")
        val user5 = User("Nicholas", "Katende", "nkatende@gmail.com", "6789")
        users.add(user1)
        users.add(user2)
        users.add(user3)
        users.add(user4)
